...
{{< showcase "IntuneFirewallMigration" "IntuneFirewallMigration is an updated version of the originally Microsoft provided tool to capture firewall rules from a target machine and upload them to Intune." "img/ifm-icon.png" "https://github.com/ennnbeee/IntuneFirewallMigration" >}}

{{< showcase "IntuneAppAssigner" "The IntuneAppAssigner PowerShell script allows for the bulk update or replacement of assignments for Android, iOS, macOS, and Windows apps in Intune." "img/iia-icon.png" "https://github.com/ennnbeee/IntuneAppAssigner" >}}
